import{s as w,e as l,c as y,u as X,t as ee,A as ae}from"./utils-p7IFJXvB.js";class P{static async getStoreConfig(){const{data:e,error:t}=await w.from("store_config").select("*").eq("id",1).maybeSingle();if(t)throw t;return{id:1,loja:(e==null?void 0:e.loja)??"Imagine Art",whatsapp:(e==null?void 0:e.whatsapp)??"",mensagem:(e==null?void 0:e.mensagem)??"Olá! Gostaria de fazer este pedido:",moeda:(e==null?void 0:e.moeda)??"BRL",banner:(e==null?void 0:e.banner)??"Escolha seus produtos personalizados.",banner_images:Array.isArray(e==null?void 0:e.banner_images)?e.banner_images:[],delivery_lead_days:Math.max(1,Number((e==null?void 0:e.delivery_lead_days)??5)),logo_url:(e==null?void 0:e.logo_url)??null,favicon_url:(e==null?void 0:e.favicon_url)??null}}static async getProducts(){const{data:e,error:t}=await w.from("products").select("*").eq("active",!0).order("created_at",{ascending:!1});if(t)throw t;return(e??[]).map(o=>({...o,custom_fields:Array.isArray(o.custom_fields)?o.custom_fields:[]}))}static async getSchools(){const{data:e,error:t}=await w.from("schools").select("*").eq("active",!0).order("name",{ascending:!0});if(t)throw t;return e??[]}static async getPaymentMethods(){const{data:e,error:t}=await w.from("payment_methods").select("*").eq("active",!0).order("name",{ascending:!0});if(t)throw t;return e??[]}}const n={config:{id:1,loja:"Imagine Art",whatsapp:"",mensagem:"Olá! Gostaria de fazer este pedido:",moeda:"BRL",banner:"",banner_images:[],delivery_lead_days:5,logo_url:null,favicon_url:null},products:[],schools:[],paymentMethods:[],cart:[]};let f=0,$=null;const te=document.querySelector("#app");function D(){te.innerHTML=`
  ...
  `).join("")}let b="",H=!1;function E(a=""){return a.normalize("NFD").replace(/[\u0300-\u036f]/g,"").toLowerCase().trim()}function G(a=""){return E(a).replace(/[^a-z0-9]+/g,"-").replace(/^-+|-+$/g,"")}function Q(){const a="/ImagineArt/".replace(/\/+$/,"");return a===""?"":a}function se(){const a=Q();let e=window.location.pathname||"/";return a&&a!=="/"&&e.startsWith(a)&&(e=e.slice(a.length)||"/"),e.startsWith("/")?e:`/${e}`}function re(a){const e=se().match(/^\/categoria\/([^/]+)/);if(!e)return null;const t=decodeURIComponent(e[1]||"");return a.find(o=>G(o)===t)||null}function ie(a){return a.find(e=>E(e).includes("touca"))||a[0]||""}function B(a){const e=Q(),t=e==="/"?"":e;return a?`${t||""}/categoria/${encodeURIComponent(G(a))}`:`${t||""}/`}function V(a,e=!1){const t=B(a);`${window.location.pathname}${window.location.search}${window.location.hash}`!==t&&window.history[e?"replaceState":"pushState"]({category:a},"",t)}function Y(){return[...new Set(n.products.map(a=>a.category||"Sem categoria"))].sort((a,e)=>{const t=E(a).includes("touca"),o=E(e).includes("touca");return t&&!o?-1:!t&&o?1:a.localeCompare(e,"pt-BR")})}function J(a=!1){const e=Y(),t=re(e);b=t||(a?ie(e):""),H=!0,a&&b&&!t&&V(b,!0)}function R(){const a=s("filtroCategoria"),e=Y();H||J(!0),a.innerHTML=`
    <button type="button" class="category-filter-btn ${b?"":"active"}" data-category="" data-url="${l(B(""))}">Todas</button>
    ${e.map(t=>`
      <button type="button" class="category-filter-btn ${t===b?"active":""}" data-category="${l(t)}" data-url="${l(B(t))}">
        ${l(t)}
      </button>
    `).join("")}
  `}function le(a,e=!0){b=a,H=!0,e&&V(a),R(),L()}function ce(){const a=s("buscaCatalogo").value.trim().toLowerCase(),e=b;return n.products.filter(t=>{const o=[t.name,t.category||"",t.description||""].join(" ").toLowerCase().includes(a),r=!e||(t.category||"Sem categoria")===e;return o&&r})}function L(){const a=s("catalogGrid"),e=ce();if(!e.length){a.innerHTML='<div class="card"><strong>Nenhum produto disponível.</strong><div style="margin-top:6px;color:#6b7280">Cadastre produtos no admin para exibir aqui.</div></div>';return}a.innerHTML=e.map(t=>{const o=t.custom_fields||[],r=t.requires_school!==!1,c=o.map((g,u)=>`
    ...
    `}).join("")}function de(){const a=s("cPagamento");if(!n.paymentMethods.length){a.innerHTML='<option value="">Nenhuma forma de pagamento disponível</option>';return}a.innerHTML=n.paymentMethods.map(e=>{const t=U(e.name).includes("pix"),o=Math.max(0,Number(e.extra_fee||0)),r=t?`${e.name} (5% de desconto)`:o>0?`${e.name} (+ ${y(o,n.config.moeda)} de taxa)`:e.name;return`<option value="${l(e.name)}">${l(r)}</option>`}).join("")}function me(a){const e=[a.size?`Tamanho: ${a.size}`:"",a.school_name?`Escola: ${a.school_name}`:"",a.child_name?`Criança: ${a.child_name}`:"",a.classroom?`Turma/Sala: ${a.classroom}`:"",I(a.personalizacao,q(a))].filter(Boolean);return e.length?e.join(" | "):"—"}function _(){var t;oe();const a=s("resumoPedido");if(!n.cart.length){a.innerHTML='<tr><td colspan="5">Nenhum item adicionado.</td></tr>';return}a.innerHTML=n.cart.map(o=>`
    <tr>
      <td>${l(o.nome)}</td>
      <td>${o.qtd}</td>
      <td>${l(me(o))}</td>
  ...
  `).join("");const e=A();if(e!==0){const o=e<0;a.insertAdjacentHTML("beforeend",`
    ...
    `)}}function ue(a){let e=document.querySelector('link[rel="icon"]');e||(e=document.createElement("link"),e.rel="icon",document.head.appendChild(e)),a&&(e.href=a)}function N(){return Array.isArray(n.config.banner_images)?n.config.banner_images.filter(Boolean):[]}function M(){const a=N(),e=document.getElementById("promoBanner"),t=document.getElementById("heroInfoPanel"),o=document.getElementById("promoBannerImg"),r=document.getElementById("promoBannerDots");if(!(!e||!o||!r)){if(!a.length){e.classList.add("hidden"),t==null||t.classList.remove("hidden"),$&&window.clearInterval($),$=null;return}t==null||t.classList.add("hidden"),e.classList.remove("hidden"),f>=a.length&&(f=0),o.src=a[f],r.innerHTML=a.map((c,d)=>`<button type="button" class="promo-dot ${d===f?"active":""}" data-role="banner-dot" data-index="${d}" aria-label="Ir para banner ${d+1}"></button>`).join(""),!$&&a.length>1&&($=window.setInterval(()=>{f=(f+1)%N().length,M()},5e3))}}function W(a){const e=N();e.length&&(f=(f+a+e.length)%e.length,M())}function pe(){s("storeNameTop").textContent=n.config.loja,s("bannerText").textContent=n.config.banner||"Escolha seus produtos personalizados.";const a=document.getElementById("brandLogoCatalog");a&&(n.config.logo_url?(a.innerHTML=`<img src="${l(n.config.logo_url)}" alt="Logo" class="brand-logo-image">`,a.classList.add("brand-logo-frame")):(a.innerHTML="",a.classList.remove("brand-logo-frame"))),ue(n.config.favicon_url),M()}function ge(a,e){const t=s(`qty-${a}`);t.textContent="1";const o=document.getElementById(`size-${a}`);o&&(o.value="");const r=document.getElementById(`school-${a}`);r&&(r.value=""),e.forEach((c,d)=>{const m=s(`field-${a}-${d}`);m&&(m.value="")})}function K(a){const e=a.normalize("NFD").replace(/[\u0300-\u036f]/g,"").toLowerCase().trim();return e==="nome"||e.includes("nome da crianca")||e.includes("nome crianca")||e.includes("crianca")||e.includes("turma")||e.includes("sala")||e.includes("escola")}function q(a){const e=n.products.find(o=>o.id===a.productId);return(e?e.requires_school!==!1:!!(a.school_name||a.child_name||a.classroom))||!!(a.school_name||a.child_name||a.classroom)}function I(a="",e=!0){return a.split("|").map(t=>t.trim()).filter(Boolean).filter(t=>{if(!e)return!0;const[o]=t.split(":");return!K(o||t)}).join(" | ")}function ve(a){var h,x;const e=n.products.find(v=>v.id===a);if(!e)return;const t=Math.max(0,Number(e.stock_quantity||0)),o=n.cart.filter(v=>v.productId===a).reduce((v,T)=>v+Number(T.qtd||0),0);if(e.track_stock&&t<=0){p("Este produto está esgotado.","error");return}const r=e.requires_school!==!1,c=e.has_sizes&&((h=document.getElementById(`size-${a}`))==null?void 0:h.value.trim())||"";if(e.has_sizes&&!c){p("Selecione o tamanho deste produto antes de adicionar.","error");return}const d=r&&((x=document.getElementById(`school-${a}`))==null?void 0:x.value.trim())||"";if(r&&!d){p("Selecione a escola deste produto antes de adicionar.","error");return}const m=Number(s(`qty-${a}`).textContent||"1");if(e.track_stock&&m+o>t){p(`Quantidade indisponível. Restam ${Math.max(0,t-o)} unidade(s).`,"error");return}const g=e.custom_fields||[];let u="",i="";const z=g.map((v,T)=>{var O;const S=((O=s(`field-${a}-${T}`))==null?void 0:O.value.trim())||"";if(!S)return"";const k=v.normalize("NFD").replace(/[̀-ͯ]/g,"").toLowerCase();return r&&((k.includes("crianca")||k==="nome")&&(u=S||u),(k.includes("turma")||k.includes("sala"))&&(i=S||i),K(v))?"":`${v}: ${S}`}).filter(Boolean).join(" | ");n.cart.push({id:X(),productId:e.id,nome:e.name,qtd:m,sale_price:e.sale_price,size:c||null,personalizacao:z,school_name:d,child_name:u,classroom:i}),ge(a,g),_(),p("Produto adicionado ao pedido.","ok")}function fe(a){const e=s("cPagamento").value.trim(),t=n.cart.map((o,r)=>[`${r+1}. ${o.qtd}x ${o.nome} — ${y(o.sale_price*o.qtd,n.config.moeda)}`,o.size?`   Tamanho: ${o.size}`:"",o.school_name?`   Escola: ${o.school_name}`:"",I(o.personalizacao,q(o))?`   Personalização: ${I(o.personalizacao,q(o))}`:"",o.child_name?`   Criança: ${o.child_name}`:"",o.classroom?`   Turma/Sala: ${o.classroom}`:""].filter(Boolean).join(`
`)).join(`
